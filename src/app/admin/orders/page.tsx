          ...
          <div className="flex flex-col lg:flex-row gap-3 items-start lg:items-end">
            ...
            <div className="w-full lg:w-auto">
              ...
              <select
                ...
                className="block w-full lg:w-40 px-2 py-1.5 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
              >
            ...
            <div className="flex gap-2 w-full lg:w-auto">
              <button
                ...
                className="flex-1 lg:flex-none px-3 py-1.5 text-xs text-gray-600 hover:text-gray-800 border border-gray-300 rounded-md hover:bg-gray-50"
              >
                Clear Filters
              </button>
              ...
              <button
                ...
                className="flex-1 lg:flex-none px-3 py-1.5 text-xs bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1.5"
              >
                {csvExporting ? (
                  <>
